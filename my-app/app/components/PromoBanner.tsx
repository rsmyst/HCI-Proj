...
export default function PromoBanner({ offers }: { offers: readonly Offer[] }) {
  return (
    <section
      id="offers"
      className="bg-slate-50 dark:bg-gray-950 py-14 transition-colors duration-300"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            Latest deals and announcements from Indian Railways
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
          {offers.map((offer) => (
            ...
            >
              <span
                className={`self-start text-xs font-semibold px-2.5 py-1 rounded-full ${toneStyles[offer.tone].tag}`}
              >
                {offer.tag}
              </span>
              <div>
              ...
              <a
                href="#"
                className="text-sm font-medium text-[#1a3c6e] dark:text-blue-400 hover:text-orange-600 dark:hover:text-orange-400 transition-colors mt-auto"
              >
                Learn more &rarr;
              </a>
            </div>
