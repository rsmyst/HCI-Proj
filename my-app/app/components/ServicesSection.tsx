      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-end justify-between gap-4 flex-wrap mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              Progressive menus reduce decision time.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {visible.map((service, index) => (
            ...
            >
              <div
                className="w-16 h-16 rounded-2xl bg-white dark:bg-gray-900 border border-blue-100 dark:border-blue-800/50 flex items-center justify-center text-[#1a3c6e] dark:text-blue-300
              ...
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5 leading-snug hidden sm:block">
                  {service.desc}
                </div>
              </div>
            </button>
